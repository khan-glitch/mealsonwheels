<x-app-layout>
    <div style="background: linear-gradient(135deg, #032E8A 0%, #0077BE 100%); min-height: 100vh; padding: 3rem 0;">
        <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <h1 style="font-size: 3.5rem; font-weight: 800; text-align: center; margin-bottom: 2rem; color: #FFD700; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">
                Caregiver Dashboard
            </h1>
            

            @if ($orders->isEmpty())
                <p class="text-center text-xl" style="color:white;">You have no meal orders yet.</p>
            @else
